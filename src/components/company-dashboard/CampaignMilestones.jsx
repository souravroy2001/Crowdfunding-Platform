...
const CampaignMilestones = () => {
    ...
    return (
        <div className="p-6">
            <h3 className={`text-lg font-semibold ${theme ? "text-gray-900" : "text-white"} mb-6`}>
                Campaign Milestones
            </h3>
                        ...
                        <div className="flex items-start space-x-4">
                            ...
                            <div className="flex-1">
                                <div className="flex justify-between items-start">
                                    ...
                                    <span className={`text-sm font-medium ${theme ? "text-gray-600" : "text-gray-300"}`}>
                                        {milestone.amount}
                                    </span>
                                </div>
                                <div className="mt-3">
                                    <div className="flex justify-between items-center text-xs mb-1">
                                        <span className={theme ? "text-gray-600" : "text-gray-300"}>Progress</span>
                                        <span className={theme ? "text-gray-600" : "text-gray-300"}>{milestone.progress}%</span>
                                    </div>
                                ...
                                <div className="mt-2 text-xs text-right">
                                    <span className={theme ? "text-gray-500" : "text-gray-400"}>{milestone.date}</span>
                                </div>
                            </div>
                        </div>
                    </div>
