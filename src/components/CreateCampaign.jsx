...
function CreateCampaign() {
  ...
  return (
    <FormProvider {...methods}>
      <CompanyNavbar />
      <div
        className={`min-h-screen flex mt-[80px] ${
              ...
              <form onSubmit={methods.handleSubmit(handleNext)}>
                ...
                <div className="pt-8">
                  <div className="flex justify-end">
                    ...
                    <button
                      type="submit"
                      className={`ml-3 inline-flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-custom ${
                        theme
                          ? "text-white bg-[#1f2937] hover:bg-[#1f2937f0]"
