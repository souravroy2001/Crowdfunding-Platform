...
const Campaigns = () => {
  const toggleTheme = useSelector((state) => state.theme.darkMode); // true = dark mode, false = light mode
  ...
  const campaign = [
    {
      ...
      daysLeft: 15,
      image:
        "https://images.unsplash.com/photo-1583842761824-63a88b5020bd?w=500",
    },
    {
      id: 2,
          ...
          >
            ...
            <input
              ...
              className={`w-full pl-10 pr-4 py-2 rounded-lg ${
                ...
                !toggleTheme ? "border-gray-900" : "border-gray-200"
              ...
              <div className="p-4">
                ...
                <div className="mb-4">
                  ...
                  <div className="w-full h-2 bg-gray-200 rounded-full overflow-hidden">
                    <div
                      className={`h-full ${
                        !toggleTheme ? "bg-[#00bfa5]" : "bg-[#00bfa5]"
                      } rounded-full`}
                      style={{
