    ...
    <div className="p-6 animate-fadeIn">
      <div className="grid grid-cols-1 gap-6">
        ...
        <div className={`${
          ...
          <h2 className={`text-xl font-bold ${toggleTheme ? 'text-gray-100' : 'text-gray-900'} mb-6`}>
            General Settings
          </h2>
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={notification.name} className="flex items-center justify-between">
                ...
                <span className={`text-sm ${toggleTheme ? 'text-gray-400' : 'text-gray-500'}`}>
        ...
        <div className={`${
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="col-span-2">
                <button className={`rounded-lg px-6 py-2.5 text-white font-medium transform hover:scale-105 transition-all duration-300 ${
        ...
        <div className="flex justify-end space-x-4">
          <button className={`rounded-lg px-6 py-2.5 font-medium transition-all duration-300 ${
            toggleTheme 
