...
const CompanyDetail = () => {
  ...
  return (
    <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div
        className={`max-w-7xl mx-auto rounded-lg shadow-lg p-8 ${
          !toggleTheme ? "bg-gray-800 text-white" : "bg-white"
        }`}
      >
        {/* Action Buttons */}
        ...
        <h2
          className={`text-2xl font-bold mb-8 ${
            toggleTheme ? "text-gray-900" : "text-gray-100"
          }`}
        >
          {companyData.name}
        </h2>
            ...
            <div className="mt-4 space-y-3">
              ...
              <div className="flex justify-between items-center text-sm">
                ...
                <span className="text-gray-900">
                  {companyData.campaign.startDate}
                </span>
              </div>
              <div className="flex justify-between items-center text-sm">
                <span className="text-gray-600">Duration:</span>
                <span className="text-gray-900">
                  {companyData.campaign.duration}
                </span>
              </div>
            </div>
          </div>
            ...
            <div className="mt-4 space-y-3">
              {Object.entries(companyData.budget).map(([key, value]) => (
                ...
                >
                  ...
                  <span
                    className={
                      key === "roi" ? "text-green-600" : "text-gray-900"
                    }
                  >
                    {value}
                  </span>
